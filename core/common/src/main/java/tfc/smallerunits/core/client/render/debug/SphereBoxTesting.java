...
//	public static void render(PoseStack pPoseStack, float pPartialTick, RenderBuffers renderBuffers, long gameTime, PoseStack pProjectionMatrix) {
////		SUVRPlayer player = VRPlayerManager.getPlayer(Minecraft.getInstance().player);
//		//SUVRPlayer player = (Minecraft.getInstance().getSingleplayerServer().getPlayerList().getPlayers().get(0));
...
//
//		Quaternionf quat = pose.getQuaternion();
//		quat.conjugate();
//
