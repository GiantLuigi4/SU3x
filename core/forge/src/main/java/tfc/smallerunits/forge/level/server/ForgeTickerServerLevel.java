...
public class ForgeTickerServerLevel extends AbstractTickerServerLevel {
	...
	public void playSeededSound(@javax.annotation.Nullable Player p_215017_, double p_215018_, double p_215019_, double p_215020_, SoundEvent p_215021_, SoundSource p_215022_, float p_215023_, float p_215024_, long p_215025_) {
		net.minecraftforge.event.PlayLevelSoundEvent.AtPosition event = net.minecraftforge.event.ForgeEventFactory.onPlaySoundAtPosition(this, p_215018_, p_215019_, p_215020_, Holder.direct(p_215021_), p_215022_, p_215023_, p_215024_);
		if (event.isCanceled() || event.getSound() == null) return;
		p_215021_ = event.getSound().value();
